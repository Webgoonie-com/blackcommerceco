                ...
                <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4 bg-gray-950">
                    <div className="lg:w-1/6 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-gray-500 hover:text-gray-800 duration-200">First Link</a>
                            </li>
                            <li>
                                <a className="text-gray-500 hover:text-gray-800 duration-200">Second Link</a>
                            </li>
                            <li>
                                <a className="text-gray-500 hover:text-gray-800 duration-200">Third Link</a>
                            </li>
                            <li>
                                <a className="text-gray-500 hover:text-gray-800 duration-200">Fourth Link</a>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/6 md:w-1/2 w-full px-4">
